...
OUT_LIB = ROOT / "librooneyj-exploration-preserve-state2-getselected-classifier.so"
...
CAVE_AREA0 = 0x003E77A0
CAVE_FLOOR2 = 0x003E7E60
CAVE_AREA4 = 0x003E7EA0
...
def main() -> None:
    ...
    blocks = [
        ...
        (
            ...
            AREA0_AFTER_CALL_PATCH,
            AREA0_AFTER_CALL_RESUME,
            False,
        ),
        (
            CAVE_FLOOR2,
            ...
            FLOOR2_AFTER_CALL_PATCH,
            FLOOR2_AFTER_CALL_RESUME,
            False,
        ),
        (
            CAVE_AREA4,
            classifier_block(CAVE_AREA4, "ldr r2, [r6, #4]\nmovs r3, #0", 0x84),
            AREA4_AFTER_CALL_PATCH,
            AREA4_AFTER_CALL_RESUME,
            False,
        ),
    ]

    # ponytail: one BSS flag is enough for this probe; widen to a small state struct only if
    # overlapping post-floor phases need to be distinguished later.
    ...
    for title, base, size in [
        ...
        ("area0 getSelected", AREA0_AFTER_CALL_PATCH, 8),
        ("floor2 getSelected", FLOOR2_AFTER_CALL_PATCH, 8),
        ("area4 getSelected", AREA4_AFTER_CALL_PATCH, 8),
        ("cave-low", 0x003E7720, 0xC0),
        ("cave-high", 0x003E7E60, 0x100),
    ]:
        print(f"\n-- {title} --")
