...
OUT_LIB = ROOT / "librooneyj-exploration-state2-action84-getselected-classifier.so"
...
CAVE_AREA0 = 0x003E7EC0
CAVE_FLOOR2 = 0x003E7F00
CAVE_AREA4 = 0x003E7F40
...
def main() -> None:
    ...
    # ponytail: combine only the two proven fixes plus one classifier family; if
    # this still fails, split identity/visibility again instead of adding more state.
