...
OUT_LIB = ROOT / "librooneyj-exploration-area-floor-latch.so"
...
def main() -> None:
    ...
    write_block(blob, "state2_reset", STATE2_RESET_CAVE, state2_reset, 0x180 - (STATE2_RESET_CAVE - ACTION_84_CAVE))
    ...
    assert_branch_target(blob, STATE2_RESET_CAVE + len(state2_reset) - 4, STATE2_RESET_RESUME)
